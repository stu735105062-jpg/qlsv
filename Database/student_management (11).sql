...
--
-- Host: localhost:3306
-- Generation Time: Jan 11, 2026 at 04:52 PM
...
(1, 1, 'present', '2026-01-11'),
(2, 1, 'absent', '2026-01-11'),
(3, 2, 'absent', '2026-01-11');
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','staff','student') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
